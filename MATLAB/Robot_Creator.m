...
dhparams = [
    ...
    0.000     -pi/2         0.000    0.000;      % l4
    0.000     0.000         0.100    0.000;      % third yaw joint
    0.000     0.000         0.200    0.000;      % End effector
    ];
...
pris = "prismatic";
fix = "fixed";
jointTypes = [rev, rev,fix ,pris, fix, rev,fix, rev, fix, rev, fix, rev, fix, rev, fix, rev];
